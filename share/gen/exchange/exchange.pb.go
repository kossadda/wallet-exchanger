...
func (x *ExchangeRequest) GetSum() float64 {
	if x != nil {
		return x.Sum
	}
	return 0
...
func (x *ExchangeResponse) GetSum() float64 {
	if x != nil {
		return x.Sum
	}
	return 0
...
var file_exchange_exchange_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x01, 0x52, 0x03, 0x73, 0x75, 0x6d, 0x12, 0x24, 0x0a, 0x0d, 0x69, 0x6e, 0x70, 0x75,
	...
	0x6d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x01, 0x52, 0x03, 0x73, 0x75, 0x6d, 0x32, 0x4e, 0x0a, 0x09,
